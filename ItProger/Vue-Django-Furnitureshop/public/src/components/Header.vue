...
<template>
  <header>
    ...
    <ul>
        ...
        <li><RouterLink to="/items" active-class="active">Товари</RouterLink></li>
    ...
    <div class="basket" v-if="showBasket">
        <div class="box"></div>
        <h3 v-if="basket.length == 0">Товарів немає</h3>
        <div class="items" v-else>
            ...
            <RouterLink to="/order"><button>Перейти до оплати</button></RouterLink>
        </div>
    </div>
  </header>
</template>
